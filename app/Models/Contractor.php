...
/**
 * عاملٌ لدى شركةٍ متعاقدة مع الشهر العقاري — يُسكَّن في مقر بمدىً زمني.
 *
 * صفته من جدول `professions` (مدخل بيانات · مترجم · عامل · سائق · مساحي).
 *
 * ⚠️ لا مقر ولا محافظة على هذا الجدول: التسكين تاريخيّ في `contractor_assignments`
...
class Contractor extends Model
{
    ...
    protected $fillable = ['name', 'profession_id', 'phone', 'notes'];

    /** صفته: مدخل بيانات · مترجم · عامل · سائق · مساحي. */
    ...
    {
        return $this->hasOne(ContractorAssignment::class, 'contractor_id')
            ->whereNull('ended_on')
