...
/**
 * بيان الأجهزة العددي: محافظة × (أعمدة الأجهزة الشغالة + إجمالي) × (أعمدة المعطلة بالنوع + إجمالي).
 */
class DeviceCountExport implements FromArray, WithHeadings, WithEvents, WithTitle, ShouldAutoSize
{
    /**
     * @param  Collection  $governorates  صفوف (id, name)
     * @param  array        $workingCols   [col => label] للأجهزة الشغالة المعروضة
    ...
    public function array(): array
    {
        ...
        // إجماليات بالنوع فقط (جمع نفس النوع عبر المحافظات) — لا جمع أفقي لأنواع مختلفة
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // المحافظة + أعمدة الشغالة + أعمدة المعطلة
