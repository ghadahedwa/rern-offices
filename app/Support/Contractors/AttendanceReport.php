 ...
 *
 *   أيام العمل = حضر + غير مراجَع + (غاب + إجازة + …)
 *
 * ⚠️ **الأعمدة تجمع أيام العمل بالضبط** — رقمٌ لا يُغلق المعادلة خطأٌ يُرى بالعين.
 * ⚠️ **«غير مراجَع» ليس «حاضراً»** (قرار العميلة، §٦ بند ٢): يوم حضورٍ **مشتقّ** يقع في
 *    (مقرّ · شهر) لم يصل كشفه يخرج «غير مراجَع». أما الغياب والإجازة **المسجَّلان فيبقيان
 *    كما هما، مراجَعاً كان الكشف أو لم يكن** — واقعةٌ كتبها المستخدم لا اشتقاق.
 */
