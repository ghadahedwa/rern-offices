...
class Create extends Component
{
    ...
    public function save(): void
    {
        ...
        if ($this->attendanceStatus?->exists) {
            ...
            Flux::toast(variant: 'success', text: __('home.ct_status_updated'));
        } else {
            AttendanceStatus::create($data);
            Flux::toast(variant: 'success', text: __('home.ct_status_created'));
        }
    ...
    {
        return view('livewire.contractors.statuses.create', ['colors' => self::COLORS]);
    }
}
