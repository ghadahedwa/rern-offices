...
namespace App\Livewire\Contractors\Statuses;
...
class Index extends Component
{
    ...
    public function askDelete(int $id): void
    {
        ...
        $this->deletingWarning = __('home.ct_status_delete_warning');
    ...
    public function deleteRow(): void
    {
        ...
        if ($status->is_system) {
            ...
            Flux::toast(variant: 'danger', text: __('home.ct_status_system_locked'));
        ...
        if ($status->isInUse()) {
            $this->reset('deletingId', 'deletingLabel', 'deletingWarning', 'showDelete');
            Flux::toast(variant: 'danger', text: __('home.ct_status_in_use'));
        ...
        $status->delete();
        $this->reset('deletingId', 'deletingLabel', 'deletingWarning', 'showDelete');
        Flux::toast(variant: 'success', text: __('home.ct_status_deleted'));
    }

    public function render()
    {
        return view('livewire.contractors.statuses.index', [
