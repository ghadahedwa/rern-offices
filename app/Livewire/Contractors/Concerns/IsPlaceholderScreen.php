...
namespace App\Livewire\Contractors\Concerns;
 ...
 * ⚠️ محتواها مرهون بجدولَي العاملين والحضور — وهما موقوفان على شكل الحالات
...
trait IsPlaceholderScreen
{
    ...
    {
        return view('livewire.contractors.placeholder', [
    ...
    {
        return __('home.ct_placeholder_note');
    }
}
