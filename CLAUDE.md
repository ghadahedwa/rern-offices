...
### الاختبارات
`php artisan test tests/Feature/Contractors` — **١٣٧ اختباراً** (`BranchScaffoldTest` ١٢ · `AttendanceStatusesTest` ١٥ · `WorkingDaysTest` ٢٠ · `OfficialHolidaysTest` ١٧ · `ContractorsTest` ٤٢ · `ContractorsImportTest` ١٦ · `ProfessionsTest` ١٠).
