...
### الاختبارات
`php artisan test tests/Feature/DataEntry` — **١١٧ اختباراً** (`BranchScaffoldTest` ١٢ · `AttendanceStatusesTest` ١٥ · `WorkingDaysTest` ٢٠ · `OfficialHolidaysTest` ١٧ · `OperatorsTest` ٤٠ · `OperatorsImportTest` ١٣).
