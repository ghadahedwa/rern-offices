...
2. **(ج-٢)** استيراد كشف الشهر بالإكسيل — مؤجَّل، تصوّره كامل في `contractors-system.md` §٦ بند ٢-أ.
3. **(هـ)** لوحة الفرع: التوزيع والأعداد ورسم الجمهورية، **بلا سجل نشاط المستخدمين**.
4. سؤال مفتوح: أيام العمل من `offices.working_days` لو اختلف مقرٌّ عن مقر؟

### الاختبارات
`php artisan test tests/Feature/Contractors` — **١٦٥ اختباراً**، منها `AttendanceGridTest` (٢٤): العرض والأيام المقفولة · حصر المقر · الحفظ والحذف والتعديل · اليوم المقفول · غياب المقر السابق · الافتراضية والمجهولة · المعطَّلة · المدسوس · الصفّ غير المُرسَل · **البصمة** · وصل الكشف ومفتاح المقر · منع الحذف · النطاق (رابط · حفظ · بحث لمنقولٍ خارج النطاق) · منسدلة المقرات · الشهر التالف. 📌 **كُسِرت حراساته الأحد عشر عمداً وسقطت كلها** (وكشف الكسر أن اختبار البحث الأول لم يبلغ حارسه فأُضيف اختبار المنقول).
