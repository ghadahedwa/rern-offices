...
- **الفلاتر والترتيب على البنية المشتركة** (`x-filter-bar` + `WithTableSorting` + `WithPerPage`) — صفٌّ واحد بخمسة فلاتر (بحث · محافظة · **نوع المقر** · مقر · حالة)، وترتيب بقائمة بيضاء (الاسم · الهاتف · تاريخ الالتحاق كعمود محسوب).
