...
- **قائمة منسدلة في خانات الأيام** (`STOP`): المفتوحة بحروف الحالات المفعَّلة، و**المقفولة (جمعة · عطلة · خارج التسكين) لا تقبل إلا «-»** — بلاغ العميلة 2026-09-17: تحققٌ واحد على الكتلة كلها كان يقبل «غ» في الجمعة فيُهمَل صامتاً. النطاقات **رأسية متصلة لكل عمود** (شمال القاهرة ١٣٩ عاملاً = ٣٠ نطاقاً · ٢٧KB).
