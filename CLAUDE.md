...
- **قائمة منسدلة في خانات الأيام** (`STOP`، حروف الحالات المفعَّلة مضمّنة) — Excel يرفض غيرها وقت الكتابة. والكتلة كلها لا المفتوحة وحدها (نطاقٌ لكل خلية يضخّم الملف).
