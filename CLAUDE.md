...
**`App\Support\Contractors\AttendanceMonthFile`** (بناء · قراءة · معاينة · حفظ) فوق `AttendanceSheet`، من قسمٍ في شاشة التسجيل نفسها (يظهر باختيار محافظة). طلب العميلة: **«أسهل طريقة بلا تعقيد»** — فالملف **صورة الشبكة بقواعدها**:
...
- القسم **مقفولٌ ما دامت في الشبكة تغييرات** (الحفظ من الملف يُعيد بناءها)، ويُصفَّر بتغيير المحافظة أو الشهر.
