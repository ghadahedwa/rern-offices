...
- **الترتيب: الأرقام أولاً والفلتر آخراً** (طلب المستخدمة): اللوحة تُفتح **لتُقرأ لا لتُملأ**، وفلترٌ فوق يدفع كل معلومة تحت حدّ الشاشة. ⚠️ ومعه **سطر «الأرقام معروضة لـ…» فوق الأرقام حين تُحدَّد محافظات**: التاريخ يحرّك «حضور الفترة» وحدها لكن **اختيار المحافظة يحرّك كل رقم في اللوحة**، فقارئٌ لا يرى الفلتر البعيد قد يقرأ أرقام محافظةٍ واحدة على أنها الجمهورية.
