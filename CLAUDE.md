...
### المتبقّي
1. **(د)** التقارير الثلاثة بمدى حرّ (مدخل · مقر · محافظة أو أكثر) + البيان العددي + التصدير — **وتُخرج غير المراجَع «غير مراجَع»** من `attendance_reviews` (مقر اليوم من التسكين). **التالي.**
2. **(هـ)** لوحة الفرع: التوزيع والأعداد ورسم الجمهورية، **بلا سجل نشاط المستخدمين**.
3. سؤال مفتوح: أيام العمل من `offices.working_days` لو اختلف مقرٌّ عن مقر؟

### الاختبارات
`php artisan test tests/Feature/Contractors` — **١٧٩ اختباراً**، منها `AttendanceMonthFileTest` (١٤: القالب · الحفظ ووصل الكشف · الهمزة · الحذف · الغائب عن الملف · الصفّ المجهول · المقفول · الشهر الآخر · ليس قالباً · بلا معرّف ومدسوس · **كلٌّ أو لا شيء بمقرّين** · **المعرّف التالف** · النطاق · التنزيل؛ 📌 كُسِرت حراساته العشرة وسقطت، واثنان منها لم يسقطا أولاً فقُوّي اختباراهما) و`AttendanceGridTest` (٢٤): العرض والأيام المقفولة · حصر المقر · الحفظ والحذف والتعديل · اليوم المقفول · غياب المقر السابق · الافتراضية والمجهولة · المعطَّلة · المدسوس · الصفّ غير المُرسَل · **البصمة** · وصل الكشف ومفتاح المقر · منع الحذف · النطاق (رابط · حفظ · بحث لمنقولٍ خارج النطاق) · منسدلة المقرات · الشهر التالف. 📌 **كُسِرت حراساته الأحد عشر عمداً وسقطت كلها** (وكشف الكسر أن اختبار البحث الأول لم يبلغ حارسه فأُضيف اختبار المنقول).
