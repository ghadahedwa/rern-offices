...
- **مخطط أعمدة لا خريطة** (قرار المستخدمة): توزيع العاملين على **المحافظات** وعلى **الصفات**، وأربع بطاقات (على رأس العمل · مقرات بها عاملون · محافظات · منتهية خدمتهم)، وحضور الفترة.
