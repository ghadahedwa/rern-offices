...
return [
    ...
    'branch_data_entry'   => 'مدخلو البيانات',
    ...
    */
    ...
    // ── مدخلو البيانات ── شاشات الفرع
    'de_operators'                => 'مدخلو البيانات',
    'de_attendance'               => 'تسجيل الحضور',
    'de_reports'                  => 'تقارير الحضور',
    'de_placeholder_note'         => 'الشاشة مُهيَّأة وصلاحياتها مُفعَّلة، ومحتواها يظهر بعد إنشاء سجل مدخلي البيانات وسجل الحضور. وحالات اليوم صارت تُدار من «إعدادات مدخلي البيانات ← حالات الحضور».',

    // ── مدخلو البيانات ── قائمة المدخلين والتسكين
    'de_operators_hint'           => 'مدخلو البيانات العاملون في مقرات محافظاتك. المدخل مُسكَّن في مقر بمدىً زمني، فالنقل يُغلق تسكينه السابق ويفتح جديداً، وإنهاء الخدمة يُغلق الأخير — وتبقى تقارير الفترات التي خدم فيها صحيحة.',
    'de_operator_add'             => 'إضافة مدخل',
    'de_operator_edit'            => 'تعديل مدخل',
    'de_operator_name'            => 'اسم مدخل البيانات',
    'de_operator_data'            => 'بيانات المدخل',
    'de_operator_assignment'      => 'التسكين',
    'de_operator_phone'           => 'رقم الهاتف',
    'de_operator_notes'           => 'ملاحظات',
    'de_operator_governorate'     => 'المحافظة',
    'de_operator_all_governorates' => 'كل المحافظات',
    'de_operator_all_offices'   => 'كل المقرات',
    'de_operators_empty'          => 'لا يوجد مدخلو بيانات مسجَّلون بعد',
    'de_operators_empty_hint'     => 'ابدأ بإضافة مدخل، أو استورد دفعة من ملف Excel.',
    'de_operators_no_match'       => 'لا نتائج مطابقة للفلاتر الحالية',
    'de_operators_no_match_hint'  => 'وسِّع الفلاتر أو امسحها لعرض بقية المدخلين.',
    ...
    'de_operator_current_office'  => 'المقر الحالي',
    'de_operator_no_office'       => 'بلا تسكين',
    'de_operator_status'          => 'الحالة',
    'de_operator_status_active'   => 'على رأس العمل',
    'de_operator_status_ended'    => 'منتهي الخدمة',
    'de_operator_status_all'      => 'الكل',
    'de_operator_assignment_note' => 'يُسكَّن المدخل في مقره عند إضافته، وبعدها يتغيّر تسكينه من زرّي «نقل» و«إنهاء خدمة» في القائمة — لا بتعديل التاريخ هنا: إعادة كتابة تاريخ الالتحاق تنسب غيابَ شهرٍ مضى إلى مقرٍّ لم يكن فيه.',
    'de_operator_transfer'        => 'نقل',
    'de_operator_transfer_title'  => 'نقل مدخل إلى مقر آخر',
    'de_operator_transfer_date'   => 'تاريخ بدء العمل في المقر الجديد',
    'de_operator_transfer_hint'   => 'ينتهي تسكينه في المقر الحالي في اليوم السابق لهذا التاريخ، فلا يُحسب يومٌ واحد في مقرّين.',
    'de_operator_transferred'     => 'تم نقل المدخل',
    'de_operator_transfer_date_invalid' => 'تاريخ النقل يجب أن يكون بعد تاريخ بدء التسكين الحالي.',
    'de_operator_end'             => 'إنهاء خدمة',
    'de_operator_end_title'       => 'إنهاء خدمة مدخل',
    'de_operator_end_date'        => 'تاريخ انتهاء الخدمة',
    'de_operator_end_hint'        => 'لا يُحذف المدخل: يخرج من الأعداد الحالية وتبقى تقارير الفترات التي خدم فيها كما هي.',
    'de_operator_ended'           => 'تم إنهاء خدمة المدخل',
    'de_operator_end_date_invalid' => 'تاريخ انتهاء الخدمة لا يسبق تاريخ بدء التسكين.',
    'de_operator_already_ended'   => 'المدخل ليس على رأس العمل أصلاً.',
    'de_operator_reassign'        => 'إعادة تسكين',
    'de_operator_reassign_title'  => 'إعادة تسكين مدخل عاد للعمل',
    'de_operator_reassign_date'   => 'تاريخ العودة للعمل',
    'de_operator_reassign_hint'   => 'يُفتح تسكين جديد من هذا التاريخ، وتبقى مدة الانقطاع خارج الحساب. استعمله أيضاً لتصحيح إنهاء خدمةٍ وقع بالخطأ.',
    'de_operator_reassigned'      => 'تمت إعادة تسكين المدخل',
    'de_operator_reassign_date_invalid' => 'تاريخ العودة يجب أن يكون بعد تاريخ انتهاء آخر تسكين.',
    'de_operator_already_in_service' => 'المدخل على رأس العمل بالفعل.',
    'de_operator_created'         => 'تمت إضافة المدخل',
    'de_operator_updated'         => 'تم تعديل بيانات المدخل',
    'de_operator_deleted'         => 'تم حذف المدخل',
    'de_operator_delete_warning'  => 'الحذف لتصحيح إدخالٍ خاطئ فقط. ومَن له سجل حضور تُنهى خدمته ولا يُحذف.',
    'de_operator_has_attendance'  => 'لا يمكن حذف مدخل له سجل حضور — أنهِ خدمته بدلاً من ذلك.',
    'de_operator_office_out_of_scope' => 'المقر المختار خارج محافظاتك.',

    // ── مدخلو البيانات ── استيراد دفعة من Excel
    'de_import_title'             => 'استيراد مدخلي بيانات',
    'de_import_button'            => 'استيراد من Excel',
    'de_import_hint'              => 'اختر المحافظة ونزّل قالبها، فيه عمود للاسم وعمود لرقم التليفون وقائمة منسدلة بمقرات المحافظة. أرسله للمفتش ليملأه، ثم ارفعه هنا لتسكين المدخلين دفعة واحدة.',
    'de_import_step_template'     => 'تنزيل القالب',
    'de_import_step_upload'       => 'رفع الملف المملوء',
    'de_import_step_review'       => 'مراجعة قبل الحفظ',
    'de_import_download'          => 'تنزيل قالب المحافظة',
    'de_import_template_note'     => 'القالب يُبنى لحظة تنزيله من مقرات المحافظة، فأي مقر يُضاف يظهر فيه تلقائياً. وعمود التليفون نصّي حتى لا يسقط الصفر الأول.',
    'de_import_file'              => 'ملف Excel المملوء',
    'de_import_reading'           => 'جارٍ قراءة الملف…',
    'de_import_started_on'        => 'تاريخ الالتحاق',
    'de_import_started_on_hint'   => 'يُطبَّق على كل من في الملف. ومَن التحق في تاريخ مختلف يُعدَّل تسكينه بعد الاستيراد.',
    'de_import_pick_governorate'  => 'اختر المحافظة أولاً.',
    'de_import_no_offices'        => 'لا مقرات في هذه المحافظة.',
    'de_import_line'              => 'السطر',
    'de_import_row_status'        => 'النتيجة',
    'de_import_row_ok'            => 'جاهز للتسكين',
    'de_import_row_no_name'       => 'الاسم فارغ.',
    'de_import_row_no_office'     => 'المقر فارغ.',
    'de_import_row_unknown_office' => 'المقر غير موجود في هذه المحافظة.',
    'de_import_row_bad_phone'     => 'رقم التليفون غير صحيح (١١ رقماً يبدأ بـ01).',
    'de_import_row_duplicate'     => 'مُسجَّل بالفعل في هذا المقر — سيُتجاوَز.',
    'de_import_count_ok'          => 'جاهز: :count',
    'de_import_count_duplicate'   => 'مكرَّر: :count',
    'de_import_count_error'       => 'خطأ: :count',
    'de_import_confirm'           => 'تسكين :count مدخلاً',
    'de_import_nothing'           => 'لا صفوف صالحة للتسكين في هذا الملف.',
    'de_import_done'              => 'تم تسكين :count مدخل بيانات',
    'de_import_empty_file'        => 'الملف لا يحتوي صفوفاً مملوءة.',

    // ── مدخلو البيانات ── إعدادات: حالات الحضور
    'de_settings'                 => 'إعدادات مدخلي البيانات',
    'de_statuses'                 => 'حالات الحضور',
    'de_statuses_hint'            => 'الحالات التي يختار المفتش منها عند تسجيل يوم لمدخل بيانات. الثلاث الأساسية (حاضر · غائب · إجازة) لا تُحذف، وما زاد عليها — مثل «حضر متأخر» أو «مأمورية» — يُضاف من هنا ويظهر في التسجيل والتقارير فوراً.',
    'de_status_add'               => 'إضافة حالة',
    'de_status_edit'              => 'تعديل حالة',
    'de_status_color'             => 'اللون',
    'de_status_order'             => 'الترتيب',
    'de_status_order_hint'        => 'ترتيب ظهور الحالة في شاشة التسجيل — الأصغر أولاً.',
    'de_status_active'            => 'حالة مُفعَّلة',
    'de_status_active_hint'       => 'المعطَّلة تختفي من شاشة التسجيل وتبقى في السجلات القديمة كما هي.',
    'de_status_system_badge'      => 'أساسية',
    'de_status_inactive_badge'    => 'معطَّلة',
    'de_status_system_note'       => 'حالة أساسية: يمكن تعديل اسمها ولونها وترتيبها، ولا تُعطَّل ولا تُحذف — فهي الحالات التي يقوم عليها التسجيل اليومي.',
    'de_status_system_locked'     => 'لا يمكن حذف حالة أساسية.',
    'de_status_in_use'            => 'لا يمكن حذف حالة مستعملة في سجل الحضور — عطِّلها بدلاً من ذلك.',
    'de_status_delete_warning'    => 'الحذف نهائي ولا يمكن التراجع عنه.',
    'de_status_created'           => 'تمت إضافة الحالة',
    'de_status_updated'           => 'تم تعديل الحالة',
    'de_status_deleted'           => 'تم حذف الحالة',

    // ── مدخلو البيانات ── إعدادات: العطلات الرسمية (سوبر أدمن)
    'de_holidays'                 => 'العطلات الرسمية',
    'de_holidays_hint'            => 'أيام العطل التي تقرّرها الدولة، تُخصم من أيام العمل في كل تقارير الحضور. الجمعة يخصمها النظام وحده فلا تُسجَّل هنا. والعطلة المُرحَّلة — كأن يُنقل المولد النبوي من الثلاثاء إلى الخميس — تُعدَّل من هنا بتغيير تاريخها، فتُصحَّح تقارير الشهر معها.',
    'de_holiday_add'              => 'إضافة عطلة',
    'de_holiday_edit'             => 'تعديل عطلة',
    'de_holiday_name'             => 'اسم العطلة',
    'de_holiday_starts_on'        => 'من تاريخ',
    'de_holiday_ends_on'          => 'إلى تاريخ',
    'de_holiday_ends_on_hint'     => 'اتركه كما هو لعطلة يوم واحد، ومدّه لعطلة متصلة (وقفة وعيد).',
    'de_holiday_days_count'       => 'عدد الأيام',
    'de_holiday_year'             => 'السنة',
    'de_holiday_all_years'        => 'كل السنوات',
    'de_holiday_created'          => 'تمت إضافة العطلة',
    'de_holiday_updated'          => 'تم تعديل العطلة',
    'de_holiday_deleted'          => 'تم حذف العطلة',
    'de_holiday_delete_warning'   => 'حذف العطلة يُعيد أيامها أيام عملٍ في كل التقارير.',
    'de_holiday_seed'             => 'زرع العطلات الثابتة',
    'de_holiday_seed_hint'        => 'يضيف عطلات السنة ثابتة التاريخ دفعة واحدة، ويتجاهل المسجَّل منها. تبقى العطلات الهجرية والمُرحَّلة تُضاف يدوياً عند إعلانها.',
    'de_holiday_seed_done'        => 'أُضيفت :count عطلة',
    'de_holiday_seed_none'        => 'كل العطلات الثابتة لهذه السنة مسجَّلة بالفعل',
    'de_holiday_conflict_title'   => 'أيام مسجَّلة داخل هذه العطلة',
    'de_holiday_conflict_body'    => 'يقع داخل هذه العطلة :count سجلّ غياب أو إجازة سُجِّل قبل إعلانها. اعتماد العطلة يحذفها، وإبقاؤها يجعل اليوم مخصوماً مرتين.',
    'de_holiday_conflict_confirm' => 'احذفها واعتمد العطلة',
    'de_holiday_conflict_cancel'  => 'رجوع',
    'de_holiday_super_admin_note' => 'العطلات الرسمية قائمة واحدة للجمهورية كلها، ولذلك يديرها السوبر أدمن وحده: تاريخ خاطئ هنا يغيّر أيام العمل في تقارير المحافظات جميعاً.',
    'de_holiday_working_days'     => 'أيام العمل',
