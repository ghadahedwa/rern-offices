    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center px-4">
        <div class="z-10 flex flex-col items-center gap-6 text-center max-w-md w-full">
            ...
            <div class="bg-white/90 rounded-2xl shadow-lg px-8 py-10 w-full border border-zinc-200">
                ...
                <p class="text-6xl font-bold mb-2" style="color: #c9a847;">404</p>
                <h1 class="text-xl font-semibold mb-2" style="color: #2c3e6b;">الصفحة غير موجودة</h1>
                <p class="text-zinc-500 text-sm mb-6">الصفحة التي تبحث عنها غير موجودة أو تم نقلها</p>
                <a href="{{ route('dashboard') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-white text-sm font-medium transition" style="background-color: #c9a847;">
