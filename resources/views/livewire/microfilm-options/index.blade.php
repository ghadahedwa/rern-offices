<div class="p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-zinc-800 dark:text-zinc-100">{{ __('home.microfilm_option_title') }}</h1>
        @if($isSuperAdmin)
            <a href="{{ route('microfilm-options.create') }}" wire:navigate
                        ...
                        @if($isSuperAdmin)
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('microfilm-options.edit', $item) }}" wire:navigate
