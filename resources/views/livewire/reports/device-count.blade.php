<div class="max-w-7xl mx-auto p-6 space-y-6">
    ...
    <div class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-semibold text-zinc-800 dark:text-zinc-100">{{ __('home.report_devices_title') }}</h1>
                <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-0.5">{{ __('home.report_devices_hint') }}</p>
            </div>
        </div>
    ...
    <div class="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 shadow-sm p-6 space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            @include('livewire.reports.includes.checkbox-group', ['field' => 'workingDevices', 'options' => $deviceOptions, 'label' => __('home.report_devices_working_filter')])
