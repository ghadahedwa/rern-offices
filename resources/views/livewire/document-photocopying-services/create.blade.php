<div class="p-6 max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-zinc-800 dark:text-zinc-100">
            {{ $documentPhotocopyingService?->exists ? __('home.edit_document_photocopying') : __('home.add_document_photocopying') }}
        </h1>
        <a href="{{ route('document-photocopying-services.index') }}" wire:navigate
