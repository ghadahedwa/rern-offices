<div class="space-y-8"
    ...
    @php $rows = $existing[$type->id]; @endphp
    ...
    <div class="rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-5 space-y-4">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <span class="text-xs font-normal text-zinc-400">· سنوية</span>
            </div>
            ...
            <table class="w-full text-sm text-right">
                ...
                <tbody class="divide-y divide-zinc-100 dark:divide-zinc-700">
                    ...
                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition">
                        ...
                        <td class="px-4 py-2.5 font-medium text-zinc-800 dark:text-zinc-100">{{ number_format($stat->value) }}</td>
        ...
        <div x-transition:enter="transition ease-out duration-200"
            ...
            <div class="bg-white dark:bg-zinc-900 px-5 py-6">
                <form wire:submit="save" class="space-y-5">
                    ...
                    <div class="flex flex-col gap-1">
                        <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">العدد <span class="text-red-500">*</span></label>
                        <input type="number" wire:model="formValue" min="0" step="1" placeholder="0"
                               class="{{ $inp }}" />
