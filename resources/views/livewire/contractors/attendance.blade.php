...
<div class="p-6 space-y-6">
    ...
    <div wire:key="attendance-{{ $office }}-{{ $monthValue }}-{{ $version }}"
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            {{-- صفحة الإكسيل مستقلة (طلب العميلة) — تُفتح على المحافظة والشهر المعروضين --}}
            <a href="{{ route('contractors.attendance-file', array_filter(['gov' => $governorate, 'month' => $monthValue])) }}" wire:navigate
               class="inline-flex items-center gap-2 border border-[#c9a847] text-[#b8962e] hover:bg-[#c9a847]/10 text-sm font-medium px-4 py-2 rounded-lg transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2m3 2v-4m3 4v-6M5 21h14a2 2 0 002-2V7.414a1 1 0 00-.293-.707l-3.414-3.414A1 1 0 0016.586 3H5a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                </svg>
