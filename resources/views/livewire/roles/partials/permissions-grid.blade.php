@php
    $labels = [
        ...
        // والوصف يذكر الأثر: التسجيل فعلٌ يومي مستقل عن تعديل بيانات العاملين
        'contractors.index'      => 'عرض العاملين بالتعاقد وتقارير الحضور',
        'contractors.attendance' => 'تسجيل الحضور والغياب والإجازات',
        'contractors.create'     => 'إضافة مدخل بيانات',
        'contractors.edit'       => 'تعديل بيانات مدخل',
        'contractors.export'     => 'تصدير وطباعة تقارير الحضور',
        'contractors.delete'     => 'حذف مدخل بيانات',
        // تحت «إدارة النظام» — قائمة مرجعية بلا نطاق محافظات
        'contractors.settings'   => 'إدارة حالات الحضور',
    ];
