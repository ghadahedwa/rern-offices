<div class="p-6 max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-zinc-800 dark:text-zinc-100">{{ __('home.add_role') }}</h1>
    ...
    <div class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-700 shadow-sm p-6">
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex flex-col gap-3">
                ...
                @error('selectedPermissions') <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
            </div>
