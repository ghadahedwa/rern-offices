...
it('يرفض الفورم الرقم القومي غير الصحيح ولا يحفظ', function (string $nationalId) {
...
})->with(['بنية غير صحيحة' => '19001010101234', 'ناقص' => '2900101010123']);
// الفراغ مقبول منذ صارت الهوية اختيارية — مغطّى في AnonymousFeedbackTest
