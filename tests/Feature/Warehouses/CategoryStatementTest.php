 ...
 *
 * «رقم الصنف» بعرضه الكامل ينكسر سطرين في صورة العمودين (العمود ١٨مم)، ومقيسٌ
 * أن **تصغير خط الرأس لا يمنعه** — mpdf يضيّق العمود على محتواه ويتجاهل النسبة
 * المعلَنة. الاسم المختصر «الرقم» وحده هو ما منعه، فلا يُبدَّل إلا بقياس.
 */
